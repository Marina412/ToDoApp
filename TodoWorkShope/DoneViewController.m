...
@property NSMutableArray *dataArray,*doneArray,*lowDataArray,*hightDataArray,*medDataArray;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
     DoneDetalsViewController  *sc=[self.storyboard instantiateViewControllerWithIdentifier:@"donesc"];
    ...
    if(_isFilterPress){
        ...
        ct=(self.doneArray)[indexPath.row];
    }
